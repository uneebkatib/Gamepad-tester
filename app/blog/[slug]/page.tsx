              ...
              <div className="bg-surface border border-border rounded-xl p-5 shadow-sm">
                ...
                <div className="flex items-center gap-2 mb-3">
                  {author.avatar.startsWith('/') ? (
                    <img src={author.avatar} alt={author.name} className="w-10 h-10 rounded-full object-cover border border-border" />
                  ) : (
              ...
              <div className="bg-surface border border-border rounded-xl p-5 shadow-sm">
                ...
                <div className="flex items-center gap-2 mb-3">
                  {reviewer.avatar.startsWith('/') ? (
                    <img src={reviewer.avatar} alt={reviewer.name} className="w-10 h-10 rounded-full object-cover border border-border" />
                  ) : (
